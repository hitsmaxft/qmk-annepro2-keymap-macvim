...
*/
 ...
 [BASE] = LAYOUT_60_ansi( /* Base */
    ...
    KC_LCTL,          KC_LALT, KC_LGUI,                   KC_SPC,             KC_RALT, MO(FN2), MO(FN1), KC_GRV
),
  /*
  * Layer FN1
  * ,-----------------------------------------------------------------------------------------.
  ...
  * |-----------------------------------------------------------------------------------------+
  * | Esc    |MS_LEFT|MS_DOWN|MS_RIGHT|  f  |  g  |left|up|down|right| PGUP|PGDN |    Enter   |
  * |-----------------------------------------------------------------------------------------+
  * | Shift      |V-UP |V-DWN|MUTE |  v  |  b  |MS_BTN1|MS_BTN2|  ,  |INSRT| DEL |    Shift   |
  * |-----------------------------------------------------------------------------------------+
 ...
 [FN1] = LAYOUT_60_ansi( /* FN1 */
    ...
    _______, _______, KC_MS_U,   _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_HOME, KC_END,  _______,
